 ...
 *
 * @phpstan-type DatabaseRow array{event_id: string, start_date: string, end_date: string}
 */
...
final class EventOccurrenceRepository
{
     ...
     */
    public function findEventOccurrencesWithinPeriod(\DateTimeImmutable $startDate, \DateTimeImmutable $endDate): iterable
    {
